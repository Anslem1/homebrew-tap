class TransitCli < Formula
  ...
  # macOS amd64
  url "https://github.com/Anslem1/transit-cli/releases/download/v1.0.2/transit_darwin_amd64.tar.gz"
  ...
  # macOS arm64
  url "https://github.com/Anslem1/transit-cli/releases/download/v1.0.2/transit_darwin_arm64.tar.gz"
  ...
  # Linux amd64
  url "https://github.com/Anslem1/transit-cli/releases/download/v1.0.2/transit_linux_amd64.tar.gz"
  ...
  # Linux arm64
  url "https://github.com/Anslem1/transit-cli/releases/download/v1.0.2/transit_linux_arm64.tar.gz"
  ...
  # Windows amd64
  url "https://github.com/Anslem1/transit-cli/releases/download/v1.0.2/transit_windows_amd64.tar.gz"
  ...
  # Windows arm64
  url "https://github.com/Anslem1/transit-cli/releases/download/v1.0.2/transit_windows_arm64.tar.gz"
